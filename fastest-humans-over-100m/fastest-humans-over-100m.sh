echo '################ delete index fastest-humans-over-100m-'"$2"' on '"$1"'###############'
...
echo '################ Remove Any Old Aliases for fastest-humanes-over-100ms And Creates a New One for fastest-humans-over-100m-'"$2"' ###############'
